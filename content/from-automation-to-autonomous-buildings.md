---
title: "빌딩은 이제 '보여주는 시스템'이 아니다 — 자동화에서 자율운영으로"
description: "업계 인터뷰 답변을 쓰며 정리한 빌딩 산업의 전환 — 감시·제어하는 BMS에서 해석·예측·제안하는 플랫폼으로, 감시자에서 오케스트레이터로. 제어만으로 에너지 16%, AI 최적화로 최대 37% 절감."
publish: true
...
tags:
  ...
  - Sustainability
---
2026년 7월, 업계 매체의 서면 인터뷰 질문지 19개에 답을 쓰며 일주일을 보냈다. 회사를 대표해 쓰는 답변이었지만, 다 쓰고 나니 오히려 내 생각이 선명해졌다. 이 산업이 지금 어디를 지나고 있는지에 대한 생각이다.

## 전환의 핵심은 기능이 아니라 철학이다

기존 빌딩관리시스템(BMS)과 차세대 플랫폼의 차이를 한 문장으로 답해야 했다. 내가 쓴 답은 이렇다. BMS는 "현재 상태를 보여주는 시스템"이었고, 차세대 플랫폼은 "무엇이 문제인지, 무엇을 먼저 조치해야 하는지, 어떻게 성과를 높일지"까지 제안하는 운영체계다.
...
인터뷰에서 가장 공들여 쓴 답은 기술이 아니라 사람에 대한 것이었다. 시스템이 See-Learn-Think-Act 루프를 스스로 돌리는 자율운영으로 갈수록, 운영자의 역할은 사라지는 게 아니라 바뀐다. 단순한 '감시자'에서, AI의 판단을 비판적으로 검토하고 조율하는 '오케스트레이터'로. 운영자는 운영 기준을 수립하고, 계획을 승인하고, 실행 결과를 검토한다. 이게 내가 연구하고 있는 Human-in-the-Loop 체계의 실무 버전이다.
...
산업 전체로 보면 방향은 하나로 수렴한다. "시스템을 얼마나 설치했는가"의 시대에서 "그 시스템이 실제로 에너지를 줄였는가, 안전을 높였는가, 운영자의 부담을 낮췄는가"의 시대로. 제품 중심에서 성과 중심으로. 이 전환의 한가운데서 일하고 있다는 것이 지금 내 일의 재미이자 무게다.

---

> [!summary] In English — From Automation to Autonomous Buildings
